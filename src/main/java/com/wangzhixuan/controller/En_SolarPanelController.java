 ...
 */
@Controller
@RequestMapping("/en_solarPanel")
public class En_SolarPanelController extends BaseController{
    @Autowired
    ...
    public String main(HttpServletRequest request) {
        ...
        return "customer/solarPanel/en_main";
    }
    @GetMapping("/en_index")
    ...
    public String newCase(HttpServletRequest request) {
        ...
        return "customer/solarPanel/en_case";
    }
    ...
    public String newProductsCenter( HttpServletRequest request,String productType) {
        ...
        return "customer/solarPanel/en_productCenter";
    }
    //进入详情页面
    ...
    public String productList(@PathVariable Integer productId, HttpServletRequest request) {
        ...
        return "customer/solarPanel/en_productDetail";
    }
    /**
     * 客户信息提交保存
     */
    ...
    public String newsDetail(@PathVariable Integer newsId, HttpServletRequest request) {
      ...
      return "customer/solarPanel/en_newsDetail";
    }

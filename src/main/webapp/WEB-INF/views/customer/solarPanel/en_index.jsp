...
<script>
    $(function() {
        ...
        $("#nav-box li a").click(function () {
            ...
            pageId = $(this).attr("id");
            //重新定义地址栏url
            var newUrl = "${path}/en_solarPanel/en_index?pageId="+pageId;
...
<div class="header">
    <div class="container">
        ...
        <div class="logo">
            <b><span style="font-size: 37px;line-height: 38px;color: #ff7700"><span style="color: #ff77004f;" >Hunan Frontier </span><span >Solar Panel</span></span></b>
        </div>
        <div class="menu">
        ...
        <div class="col-md-2 box_5">
            ...
            <div class="footer-list1">
                <ul>
                    ...
                    <li><a href="http://www.150ah.com/solarPanel/index" style="color: #bd4932">Solar Panel</a></li>
...
<div class="footer_bottom footer_bottom_box">
    <div class="container">
        <div class="copy">
            <p>Copyright ©Permanent New Energy Co., Ltd.<a href="http://www.miitbeian.gov.cn" rel="nofollow" style="color: #989898" target="_blank">&nbsp;&nbsp;Xiang ICP 16021270-1</a></p>
        </div>

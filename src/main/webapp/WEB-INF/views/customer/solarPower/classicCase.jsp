      ...
      <div class="container">
        ...
        <div id="blog-slide" class="with-nav">
          <c:forEach var="demo" items="${caseImage}">
            <div class="blog-post">
              <article><img class="img-responsive" src="${staticPath}/static${demo.imagePath}${demo.fileName}"
                            alt=""><span><i class="fa fa-bookmark-o"></i><fmt:formatDate value="${demo.updateTime}" pattern="yyyy-MM-dd HH:mm:ss"/></span>

            ...
            <div class="container-fluid">
                <div class="row">
                                    ...
                                    <c:forEach items="${ADImages}" var="li">
                                        ...
                                        <li data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" >
                                            ...
                                            <div class="tp-caption lfb tp-resizeme scroll"
                                                 ...
                                                 data-endspeed="300"
                                                 data-scrolloffset="0"
                                                 style="z-index: 8;"><a target="_blank" href="https://guangheguineng.tmall.com/shop/view_shop.htm?shop_id=113563151" class="btn-round big">Buy At Once</a> </div>
                                        </li>
                                    </c:forEach>
                    ...
                    <div class="col-md-3 no-padding">
                        ...
                        <!-- New line required  -->
                        <div class="product">
                            <div class="like-bnr" style="background:#f5f5f5 url(${staticPath}/static/customer/images/solar-img-1.jpg) left top no-repeat">
                        ...
                        <div class="week-sale-bnr">
                            <h4>Activities <span> this week!</span></h4>
                            <p>All online products enjoy special discounts</p>
                            <a target="_blank"  href="https://guangheguineng.tmall.com/shop/view_shop.htm?shop_id=113563151" class="btn-round">Buy At Once</a> </div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <section class="featur-tabs padding-top-60 padding-bottom-60">
            <div class="container">
                ...
                <ul class="nav nav-tabs nav-pills margin-bottom-40" role="tablist">
                    <li role="presentation" class="active"><a href="#featur" aria-controls="featur" role="tab" data-toggle="tab">Genuine guarantee</a></li>
                ...
                <div class="tab-content">
                    ...
                    <c:forEach items="${aboutImage}"  begin="0" var="about" >
                ...
                <div class="container">
                    ...
                    <div class="item-col-5">
                        ...
                        <div class="product col-2x">
                            <div class="like-bnr" style="background: #f5f5f5 url(${staticPath}/static/customer/images/solar-img-2.jpg) right center no-repeat">
                        ...
                        <div class="product">
                            <article> <img class="img-responsive" src="${staticPath}/static${hot.imagePath}${hot.fileName}" alt="" > <span class="sale-tag">hot</span>
                                ...
                                <!-- Content -->
                                <span class="tag">Solar panels</span> <a href="${path }/customer/productDetail/${hot.productId}" class="tittle"> ${hot.imageTitle}</a>
                                <!-- Reviews -->

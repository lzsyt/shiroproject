...
<head>
    ...
    <style type="text/css">
      ...
      .suspension .d-service-item .i-qq{
        width:44px;
        height:44px;
        background:url(${staticPath}/static/windEnergy/talk/images/skype.jpg) no-repeat center 15px;
        display:block;
        transition:all .2s;
      ...
      .suspension .d-service-item .i-email{
        width:44px;
        height:44px;
        background:url(${staticPath}/static/windEnergy/talk/images/timg.jpg) no-repeat center 15px;
        display:block;
        transition:all .2s;
        background-color: #f1f1f3;
        border-radius:50%;
        overflow:hidden;}
      .suspension .d-service-item:hover .i-email{
...
<div class="suspension">
    <div class="suspension-box">
        <a target="_blank" href="mailto:sale@windturbine.com" class="a a-email "><img src="${staticPath}/static/windEnergy/talk/images/email.png" style="width: 26px;margin:9px 9px " /></a>
        ...
        <div class="d d-email" style="top:0">
          <i class="arrow"></i>
          <div class="inner-box">
            <div class="d-service-item clearfix">
              <a target="_blank" href="mailto:sale@windturbine.com" class="clearfix"><span class="circle"><i class="i-email" ></i></span><h3 style="line-height: 25px">Email:<br><span>sale@windturbine.com</span></h3></a>
            </div>
          </div>
        </div>
        <div class="d d-service" style="top:20px">
            <i class="arrow"></i>
            <div class="inner-box">
                    <div class="d-service-item clearfix">
                        <a target="_blank" href="skype:windturbine.com?chat" class="clearfix"><span class="circle"><i class="i-qq"></i></span><h3 style="line-height: 25px">Skype:<br><span>windturbine.com</span></h3></a>
                    </div>
            </div>
        </div>

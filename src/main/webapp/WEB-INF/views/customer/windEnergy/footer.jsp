    ...
    <div class="col-md-2 box_5">
      ...
      <div class="footer-list1">
        <ul>
          ...
          <li><a href="http://yongdong.com.cn" style="color: #bd4932">风力发电机</a></li>
          <li><a href="http://www.guanghe.cn">太阳能电池板</a></li>
          <li><a href="http://www.kongzhiqi.com">控制器</a></li>
        </ul>
      </div>
    </div>
    <div class="col-md-2 box_5">
      <h3><a href="${path}/windEnergy/aboutUs" target="myframe" class="aboutUs">企业文化</a></h3>
      <div class="footer-list1">
        <ul>
...
<div class="footer_bottom footer_bottom_box">
  <div class="container">
    <div class="copy">
      <p>Copyright ©永动新能源有限公司 <a href="http://www.beian.miit.gov.cn" rel="nofollow" style="color: #989898" target="_blank" >&nbsp;&nbsp; 湘ICP备16021270号-5</a></p>
    </div>
...
<script>
  ...
  $(function(){
    $("#btn_img1").click(function(){
      var img = '<img src="${staticPath}/static/windEnergy/talk/images/wx.jpg" alt="光合硅能"/>';
      layer.open({
        type: 1,
        title: false,
        closeBtn: 0,

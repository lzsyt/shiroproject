        ...
        <ul id="new">
            <c:forEach items="${page.getRecords() }" var="news">
              <li>
                ...
                <div class="hr"></div>
                <div class="con">
                  <a href="/windEnergy/newsDetail/${news.newsId}">
      ...
      <div class="row " style="text-align: center">
        ...
        <div class="col-md-12">
          <nav aria-label="Page navigation">
            <ul class="pagination">
              <li><a href="${staticPath }/windEnergy/newsCenter?pg=1">首页</a></li>
              <c:if test="${page.hasPrevious() }">
                <li><a href="${staticPath }/windEnergy/newsCenter?pg=${page.getCurrent()-1}"
              ...
              <li><a href="${staticPath }/windEnergy/newsCenter?pg=${page.getPages()}">末页</a></li>

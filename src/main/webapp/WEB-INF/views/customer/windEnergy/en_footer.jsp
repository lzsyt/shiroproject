...
<head>
  ...
  <style>
      ...
      float: left;margin-left:5px;padding: 5px 0px
    }
  ...
  <div class="container-fluid container-fluid_box footer-flex">
    <div class="col-md-3 box_5">
      ...
      <div class="footer-list1" style="text-align: left">
        <span>Email:sale@windturbine.com</span><br>
    ...
    <div class="col-md-2 box_5">
      ...
      <div class="footer-list1">
        <ul>
          ...
          <li class="first_li"><a href="http://www.windturbine.com" style="color: #bd4932">Wind Turbines</a></li>
    ...
    <div class="col-md-1 box_5">
      ...
      <div class="map_box" style="text-align: right">
        ...
        <p class="world">Best-selling worldwide</p>
      </div>
    </div>
  </div>
...
<div class="footer_bottom footer_bottom_box">
  <div class="container">
    <div class="copy">
      <p>Copyright ©Permanent New Energy Co., Ltd. <a href="http://www.beian.miit.gov.cn" rel="nofollow" style="color: #989898" target="_blank">&nbsp;&nbsp;Xiang ICP No. 16021270 No.-5</a></p>
    </div>
...
<div id="en_footer_content" >
  <div class="container">
    ...
    <form>
      <input class="first_input" id="email"  placeholder="Please Enter Your Email">
      <%--<input class="second_input"   placeholder="Please Enter Your Phone Number">--%>
      <button class="mes_submit" id="mes_submit" >submit</button>
    </form>
    </div>
    <div class="hotline_wrapper" >
      <span class="first_span" >Email</span>
      <span class="second_span" >sale@windturbine.com</span>
    </div>
    </div>
</div>
...
<script>
  ...
  $("#mes_submit").click(function(){
    ...
    var data={"email":email,"website":website};
    $.ajax({
      type: 'POST',

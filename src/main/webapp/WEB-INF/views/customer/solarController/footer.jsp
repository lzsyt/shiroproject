...
<body>
<div class="footer">
  <div class="container-fluid container-fluid_box" style="padding-bottom: 50px">
    <div class="col-md-3 box_5">
      ...
      <div class="all-contnet">
        <div class="all-img">
          <img src="${staticPath}/static/windEnergy/images/photo_floor.png" alt="湖南前沿官网图片">
        </div>
        <div class="all-text">
          <p>总机</p>
    ...
    <div class="col-md-2 box_5">
      ...
      <div class="footer-list1">
        <ul>
          <li><a href="http://kongzhiqi.com/solarController/productDetail/18">防水路灯控制器</a></li>
          <li><a href="http://kongzhiqi.com/solarController/productDetail/19">防水市电互补控制器</a></li>
          <li><a href="http://kongzhiqi.com/solarController/productDetail/20">风光互补大功率控制器</a></li>
          <li><a href="http://kongzhiqi.com/solarController/productDetail/21">风机控制器</a></li>
          <li><a href="http://kongzhiqi.com/solarController/productDetail/22">风光互补控制器</a></li>
          <li><a href="http://kongzhiqi.com/solarController/productDetail/23">蓝白太阳能控制器</a></li>
          <li><a href="http://kongzhiqi.com/solarController/productDetail/24">绿黑壳太阳能控制器</a></li>
          <li><a href="http://kongzhiqi.com/solarController/productDetail/25">太阳能MPPT控制器</a></li>
          <li><a href="http://kongzhiqi.com/solarController/productDetail/26">太阳能灰壳控制器</a></li>
        </ul>
      </div>
    </div>

    <div class="col-md-2 box_5">
      <h3><a href="${path}/solarController/main" class="aboutUs">首页</a></h3>
      <div class="footer-list1">
        <ul>
          ...
          <li><a href="${path}/solarController/newsCenter" class="case">新闻中心</a></li>
        </ul>
      </div>
    </div>
    <%--        <div class="col-md-3 box_5">--%>
    ...
    <div class="col-md-4 box_5">
      ...
      <div>
        <img id="btn_img1" src="${staticPath}/static/windEnergy/talk/images/wx.jpg" style="width:135px" alt="光合硅能">
  ...
  <div class="fLink container" id="fLink" style="margin-bottom: 50px;width: 1543px;margin-left: 175px;">
    <div class="f_title" style="border-bottom: 1px solid #989898">
      <span style="color: #989898;font-size: 1.5em">友情链接</span>
    </div>
    <div>
      <ul class="f_main">
        <li><a href="http://www.150ah.com">光合硅能</a></li>
        <li><a href="http://yongdong.com.cn">风力发电机</a></li>
        <li><a href="http://guanghe.cn">太阳能电池板</a></li>
        <li><a href="http://kongzhiqi.com" style="color: #bd4932">控制器</a></li>
      </ul>
    </div>
  </div>
</div>
<div class="footer_bottom footer_bottom_box">
  <div class="container">
    <div class="copy">
      <p>Copyright ©永动新能源有限公司<a href="http://www.beian.miit.gov.cn" rel="nofollow" style="color: #989898" target="_blank">&nbsp;&nbsp;湘ICP备16021270号-3</a>
      </p>
    </div>

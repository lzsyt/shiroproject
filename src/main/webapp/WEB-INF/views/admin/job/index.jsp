    ...
    var vue = new Vue({
        ...
        methods: {
            ...
            loadData: function(pageNum, pageSize){
                this.$http.get('/shiro/job/queryjob?' + 'pageNum=' +  pageNum + '&pageSize=' + pageSize).then(function(res){
                    console.log(res)
            ...
            handleDelete: function(index, row) {
                this.$http.post('/shiro/job/deletejob',{"jobClassName":row.job_NAME,"jobGroupName":row.job_GROUP},{emulateJSON: true}).then(function(res){
            ...
            handlePause: function(index, row){
                this.$http.post('/shiro/job/pausejob',{"jobClassName":row.job_NAME,"jobGroupName":row.job_GROUP},{emulateJSON: true}).then(function(res){
                    this.loadData( this.currentPage, this.pagesize);
                },function(){
                    console.log('failed');
                });
            ...
            handleResume: function(index, row){
                this.$http.post('/shiro/job/resumejob',{"jobClassName":row.job_NAME,"jobGroupName":row.job_GROUP},{emulateJSON: true}).then(function(res){
                    this.loadData( this.currentPage, this.pagesize);
                },function(){
                    console.log('failed');
                });
            ...
            //添加
            add: function(){
                this.$http.post('/shiro/job/addjob',{"jobClassName":this.form.jobName,"jobGroupName":this.form.jobGroup,"cronExpression":this.form.cronExpression}).then(function(res){
                    this.loadData(this.currentPage, this.pagesize);
            ...
            addSimTir: function () {
                ...
                this.$http.post('/shiro/job/addjob',{"jobClassName":this.form.jobName,"jobGroupName":this.form.jobGroup,"cronExpression":this.form.cronExpression,
